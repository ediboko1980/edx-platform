...
from support.views.program_enrollments import (
    LinkProgramEnrollmentSupportView,
    ProgramEnrollmentsConsoleView,
)
...
urlpatterns = [
    ...
    url(r'program_enrollments_console/?$', ProgramEnrollmentsConsoleView.as_view(), name='program_enrollments_console')
]
